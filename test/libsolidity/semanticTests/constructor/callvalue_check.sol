...
// compileViaYul: also
// ----
// f(uint256), 2000 lat: 0 -> true
// f(uint256), 2000 lat: 100 -> false
// g(uint256), 2000 lat: 0 -> true
// g(uint256), 2000 lat: 100 -> false
// h(uint256), 2000 lat: 0 -> true
// h(uint256), 2000 lat: 100 -> false
// i(uint256), 2000 lat: 0 -> true
// i(uint256), 2000 lat: 100 -> false
