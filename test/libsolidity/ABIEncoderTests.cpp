...
BOOST_AUTO_TEST_CASE(storage_array_dyn)
{
	string sourceCode = R"(
		contract C {
			...
			event E(address[] a);
			function f() public {
				addr.push('lat1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqpfr7f80');
				addr.push('lat1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqz8stlfs');
				addr.push('lat1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqr6xl25z');
				emit E(addr);
			}
		}
	)";
