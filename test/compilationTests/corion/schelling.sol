...
contract schellingDB is safeMath, schellingVars {
    ...
    */
    ...
    function replaceOwner(address newOwner) external returns(bool) {
        require( owner == address('lat1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq542u6a') || msg.sender == owner );
        owner = newOwner;
        return true;
    }
    ...
    */
    ...
    function getRewards(address beneficiary) isReady noContract external {
        ...
        */
        ...
        if (beneficiary != address('lat1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq542u6a')) { _beneficiary = beneficiary; }
        uint256 reward;
