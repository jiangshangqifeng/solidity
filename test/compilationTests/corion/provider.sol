    ...
    */
    ...
    function getUserDetails(address payable addr, uint256 schellingRound) public view returns (address ProviderAddress, uint256 ProviderHeight, uint256 ConnectedOn, uint256 value) {
        ...
        */
        ...
        if ( clients[addr].providerAddress != address('lat1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq542u6a') ) {
    ...
    function createProvider(bool priv, string calldata name, string calldata website, string calldata country, string calldata info, uint8 rate, bool isForRent, address payable admin) isReady external {
        ...
        */
        ...
        require( clients[msg.sender].providerAddress == address('lat1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq542u6a') );
        require( ! checkICO() );
        if ( priv ) {
        ...
        if ( admin == address('lat1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq542u6a') ) {
    ...
    function partProvider() isReady external {
        ...
        */
        ...
        require( provider != address('lat1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq542u6a') );
    ...
    function checkReward(address addr) public returns (uint256 reward) {
        ...
        */
        ...
        } else if ( clients[addr].providerAddress != address('lat1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq542u6a') ) {
    ...
    function getReward(address beneficiary, uint256 limit, address provider) isReady external returns (uint256 reward) {
        ...
        */
        ...
        if ( _beneficiary == address('lat1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq542u6a') ) { _beneficiary = msg.sender; }
        if ( _provider == address('lat1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq542u6a') ) { _provider = msg.sender; }
        ...
        } else if ( clients[msg.sender].providerAddress != address('lat1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq542u6a') ) {
