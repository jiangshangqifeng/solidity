...
abstract contract ManagedAccountInterface {
    ...
    // If true, only the owner of the account can receive lat from it
    bool public payOwnerOnly;
    // The sum of lat (in von) which has been sent to this contract
...
contract ManagedAccount is ManagedAccountInterface{
    ...
    // It counts the amount of lat it receives and stores it in
    // accumulatedInput.
