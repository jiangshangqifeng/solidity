...
abstract contract ManagedAccountInterface {
    ...
    // If true, only the owner of the account can receive atp from it
    bool public payOwnerOnly;
    // The sum of atp (in von) which has been sent to this contract
    uint public accumulatedInput;

    /// @notice Sends `_amount` of von to _recipient
    /// @param _amount The amount of von to send to `_recipient`
    /// @param _recipient The address to receive `_amount` of von
...
contract ManagedAccount is ManagedAccountInterface{
    ...
    // It counts the amount of atp it receives and stores it in
    // accumulatedInput.
