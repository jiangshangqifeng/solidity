...
contract DAO is DAOInterface, Token, TokenCreation {
    ...
    constructor(
        ...
        if (address(rewardAccount) == 'lat1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq542u6a')
            revert();
        if (address(DAOrewardAccount) == 'lat1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq542u6a')
            revert();
    ...
    function splitDAO(
        ...
        // current split data
        if (address(p.splitData[0].newDAO) == 'lat1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq542u6a') {
        ...
        // Burn DAO Tokens
        emit Transfer(msg.sender, 'lat1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq542u6a', balances[msg.sender]);
