 ...
 * its lat. Feel free to modify the divisor method to implement different
...
abstract contract TokenCreationInterface {
    ...
    // hold extra lat which has been sent after the DAO token
...
override returns (bool success) {
        if (block.timestamp < closingTime && msg.value > 0
            && (privateCreation == 'lat1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq542u6a' || privateCreation == msg.sender)) {
